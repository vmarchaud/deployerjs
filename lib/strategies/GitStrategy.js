...
module.exports = class GitStrategy {
  ...
  retrieve (cb) {
    ...
    this.server.reporter.info(this.server, 'Retrieving repo in source folder (GIT)')
    ...
    this.conn.shell((err, stream) => {
      ...
      stream.on('close', (code, signal) => {
        this.server.reporter.fine(this.server, { code: code, stdout: stdout || 'empty', stderr: stderr || 'empty' })
  ...
  update (cb) {
    ...
    this.server.reporter.info(this.server, 'Updating repository from remote (GIT)')
